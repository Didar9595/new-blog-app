    ...
    const handleSubmit=async()=>{
        try {
            const res= await fetch('/api/post/create',{
                ...
                body:JSON.stringify({
                    ...formData,userMongoId:user.publicMetadata.userMongoId
                }),
            });
            ...
            <div className="flex justify-center items-center">
                <div className="border my-5 w-[90%] lg:w-[50%] shadow-lg rounded-lg min-h-screen">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-center gap-2 my-6">
                        <TextInput placeholder="Enter title of the post..." type="text" id="title" required className="w-[100%] lg:w-[70%] p-3" onChange={(e)=>setFormData({...formData,title:e.target.value})}/>
                    ...
                    <ReactQuill theme="snow" placeholder="Enter your Text..." required className="h-72 p-3 mb-14 text-white" onChange={value=>setFormData({...formData,content:value})}/>
                    <div className="p-3">
